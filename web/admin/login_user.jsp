...
<html>
    ...
    <body>
     <%if (request.getParameter("Action_user") != null) {
                ...
                try {
                    ...
                    String mem_id = request.getParameter("txtUsername");
        ...
        <br><br>
    <center>
        <form name="frmLogin" method="post" action="login_user.jsp?Action_user=Login">
            ...
            <table border="0" style="width: 300px">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input name="txtUsername" style="width: 300px" type="text" id="txtUsername" placeholder="กรุณากรอกรหัสสมาชิก">
                        </td>
                    </tr>
                    <tr>
