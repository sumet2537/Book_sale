    ...
    <body>
        ...
        <div >
            <div class="row">
                <div class="container">
                    <center>
                        <h1><font color="red">โปรโมชั้น</font></h1>

                    <label> <h2>เมื่อซื่อสินค้าครบ 1000 บาท เราแถมให้คุณฟรีอีกเล่มหนึ่ง</h2></label><br>
                    <label>    <p class="text-danger">ใหม่ล่าสุด</p></label><br>
                    <label>   <h2>ซื่อ2เล่มขึ้นไปมีส่วนลด</h2></label><br>
                    <br><br><br><br><br>
                    </center>
                </div>
            </div>
