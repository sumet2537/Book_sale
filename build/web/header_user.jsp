        ...
        <div class="container">
            <nav class="navbar navbar-inverse">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index_user.jsp"><i class="glyphicon glyphicon-home"></i> หน้าหลัก</a>
                </div>
                <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" aria-expanded="false" >
                    <ul class="nav navbar-nav">
                        <li> <a  href="promotion1.jsp"><i class="glyphicon glyphicon-gift"></i>โปรโมชั้น</a></li>
                        <li>  <a  href="index_user.jsp"><i class="glyphicon glyphicon-inbox"></i>สินค้า</a></li>
